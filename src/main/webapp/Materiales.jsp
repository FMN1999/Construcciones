    ...
    <div class="modal-content">
      ...
      <form method="post" action="Materiales" >
	      ...
	      <div class="form-floating mb-3 mt-3">
			  <input type="text" class="form-control" id="idmaterial" placeholder="idmaterial" name="idmaterial" readonly>
			  <label for="idprov">ID Material</label>
		  </div>
		  <div class="form-floating mb-3 mt-3">
			  <input type="text" class="form-control" id="descripcionmaterial" placeholder="descripcionmaterial" name="descripcionmaterial" required>
			  <label for="razonsocial">Descripcion</label>
		  </div>
		  <div class="form-floating mb-3 mt-3">
			  <input type="number" class="form-control" id="preciomaterial" placeholder="preciomaterial" name="preciomaterial" required>
