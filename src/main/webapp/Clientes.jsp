...
<html>
	...
	<body>
		...
		<%@page import="main.java.entidades.Cliente" %>
		<div>
		    ...
		    <div class="modal-content">
		      ...
		      <form method="post" action="Clientes" >
			      ...
			      <div class="form-floating mb-3 mt-3">
					  <input type="text" class="form-control" id="idusuario" placeholder="id" name="idusuario" readonly>
		...
		<script type="text/javascript">
			...
			for (i = 0; i < table1.rows.length; i++) {
			    table1.rows[i].onclick = function () {
			        ...
			        document.getElementById('idusuario').value = this.cells[6].innerHTML;
			        ...
			        document.getElementById('razon_social').value = this.cells[1].innerHTML;
