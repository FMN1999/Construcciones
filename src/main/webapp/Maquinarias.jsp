			...
			<div class="modal-content">
				...
				<form method="post" action="Maquinarias">
					...
					<div class="form-floating mb-3 mt-3">
						<input type="text" class="form-control" id="idmaq"
							placeholder="id" name="idmaq" readonly> <label
							for="idmaq">ID MAQUINARIA</label>
					</div>
					<div class="form-floating mb-3 mt-3">
					...
					<div class="form-floating mb-3 mt-3">
						<input type="number" class="form-control" id="precioHora"
							placeholder="Precio por Hora" name="precioHora" required>
