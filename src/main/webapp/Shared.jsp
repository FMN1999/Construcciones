...
<%@page import="entidades.Usuario"%>
  ...
  <symbol id="screwdriver" viewBox="0 0 16 16">
  	<path
  ...
  <symbol id="sueldo" viewBox="0 0 16 16">
				...
				<div
					...
					<ul
						...
						<li><a href="Materiales" class="nav-link text-white"> <svg
									class="bi d-block mx-auto mb-1" width="24" height="24">
									<use xlink:href="#grid"></use></svg> Materiales
						</a></li>
						<li><a href="Clientes" class="nav-link text-white"> <svg
									class="bi d-block mx-auto mb-1 text-white" width="24"
									height="24">
									<use xlink:href="#people-circle"></use></svg> Clientes
						</a></li>
						<li><a href="Proveedores" class="nav-link text-white"> <svg
									class="bi d-block mx-auto mb-1 text-white" width="24"
									height="24">
									<use xlink:href="#people-circle"></use></svg> Provedores
						</a></li>
						<!-- El de las maquinarias -->
						<li><a href="Maquinarias" class="nav-link text-white"> <svg
									class="bi d-block mx-auto mb-1" width="24" height="24">
									<use xlink:href="#table"></use></svg> Maquinarias
						</a></li>
						<li><a href="Empleados" class="nav-link text-white"> <svg
									class="bi d-block mx-auto mb-1 text-white" width="24"
									height="24">
						...
						<li><a href="Sueldos" class="nav-link text-white"> <svg
									class="bi d-block mx-auto mb-1" width="24" height="24">
									<use xlink:href="#sueldo"></use></svg> Sueldos
						</a></li>
