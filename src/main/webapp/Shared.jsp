      ...
      <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
          ...
          <ul class="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small">
            ...
            <li>
              <a href="Tipo_Tareas" class="nav-link text-white">
                <svg class="bi d-block mx-auto mb-1" width="24" height="24"><use xlink:href="#screwdriver"></use></svg>
                Tipos Tareas
              </a>
            </li>
            <li>
            ...
            <li>
             ...
             <!-- El de las maquinarias -->
             <li>
              <a href="Maquinarias" class="nav-link text-white">
            ...
            <li>
             <a href="Empleados" class="nav-link text-white">
             	<svg class="bi d-block mx-auto mb-1 text-white" width="24" height="24"><use xlink:href="#person-badge"></use></svg>
             	Empleados
             </a>
          </ul>
