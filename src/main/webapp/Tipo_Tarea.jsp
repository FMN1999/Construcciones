			...
			<div class="modal-content">
				...
				<form method="post" action="Tipo_Tareas">
					...
					<div class="form-floating mb-3 mt-3">
						<input type="text" class="form-control" id="idtipotarea"
							placeholder="idtipotarea" name="idtipotarea" readonly> <label
							for="idprov">ID TipoTarea</label>
					</div>
					<div class="form-floating mb-3 mt-3">
						<input type="text" class="form-control" id="descripciontipotarea"
							placeholder="descripciontipotarea" name="descripciontipotarea"
							required> <label for="razonsocial">Descripcion</label>
					</div>
					<div class="form-floating mb-3 mt-3">
						<input type="number" class="form-control" id="preciotipotarea"
							placeholder="preciotipotarea" name="preciotipotarea" required>
