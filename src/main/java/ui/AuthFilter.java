 ...
 */
@WebFilter(urlPatterns = { "/AuthFilter", "/Home", "/", "/Proveedores", "/Materiales", "/Maquinarias", "/Empleados", "/Clientes", "/Tipo_Tareas" }, servletNames = { "Home", "Proveedores", "Materiales", "Maquinarias", "Empleados", "Clientes", "Tipo_Tareas" })
