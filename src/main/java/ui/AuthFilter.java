 ...
 */
@WebFilter(urlPatterns = { "/AuthFilter", "/Home", "/", "/Proveedores", "/Materiales", "/Maquinarias" }, servletNames = { "Home", "Proveedores", "Materiales", "Maquinarias", "Empleados", "Clientes", "Tipo_Tareas" })
